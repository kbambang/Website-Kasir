...
<script>
    ...
    $(function () {
        ...
        // Ambil nilai total item dan total bayar
        let totalItem = parseInt($('#total_item').val());
        let totalBayar = parseFloat($('#bayar').val().replace(/[^0-9.-]+/g, ""));
        
        // Validasi apakah ada produk yang ditambahkan
        if (totalItem === 0 || isNaN(totalBayar) || totalBayar === 0) {
            Swal.fire({
                icon: 'error',
                title: 'Gagal',
                text: 'Tidak dapat menyimpan transaksi. Pastikan Anda telah menambahkan produk.',
                confirmButtonText: 'Oke'
            });
            return;
        }
    ...
    // Event untuk menangani form-pembelian submit
    $('.form-pembelian').on('submit', function(e) {
        ...
        .done(function(response) {
            ...
            Swal.fire({
                ...
                // Redirect atau reload halaman setelah alert
